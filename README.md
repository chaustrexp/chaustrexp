...
* 🧠 Sólidas bases en lógica de programación, bases de datos y desarrollo backend con **PHP (Laravel)**, **Java (Spring Boot)** y **Node.js**.
...
* 🇺🇸 Practicar inglés.
* 🏋️‍♂️ Entrenamiento físico e hipertrofia.
